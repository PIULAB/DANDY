...
unsigned int DynamixelClass::setAccelerationGoal(unsigned char ID, unsigned char Goal){

	Instruction_Packet_Array[0] = ID;
	Instruction_Packet_Array[1] = SET_ACCEL_GOAL_LENGTH;
	Instruction_Packet_Array[2] = COMMAND_WRITE_DATA;
	Instruction_Packet_Array[3] = RAM_GOAL_ACCEL;
	Instruction_Packet_Array[4] = Goal;
	Instruction_Packet_Array[5] = ~(ID + SET_ACCEL_GOAL_LENGTH + COMMAND_WRITE_DATA+ RAM_GOAL_ACCEL + Goal);
